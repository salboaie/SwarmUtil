...
function SwarmClient ( host, port, user, pass, tenantId) {
...
SwarmClient.prototype.resolveMessage = function (object) {
    dprint("Received " + J(object));
    if(object.meta != undefined && object.meta.changeSessionId == true){
        dprint("Renaming session " + this.sessionId + " to " + object.sessionId);
...
exports.createClient = function(host, port, user, pass,tenantId) {
    return new SwarmClient(host, port, user, pass, tenantId);
}
