...
SwarmingPhase.prototype.swarm = function (phaseName, nodeHint ) {
    ...
    try{
        ...
        if(this.meta.debug == true){
            dprint("Starting swarm "+this.swarmingName +  " towards " + targetNodeName + ", Phase: "+ phaseName);
        }
...
SwarmingPhase.prototype.safeSwarm = function (phaseName, nodeHint,timeOut,retryTimes,save) {
