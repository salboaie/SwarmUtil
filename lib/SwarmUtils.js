...
logDebug = function(message,aspect,err){
    var errStr;
    var stack;
    if(err!=null){
        errStr = err.toString();
...
logInfo = function(message,aspect,obj){
    if(aspect == undefined){
        aspect = "INFO";
    }
    startSwarm("log.js","info",[message,aspect,obj,executionContext.tenantId,executionContext.sessionId]);
}
