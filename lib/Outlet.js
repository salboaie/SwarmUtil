...
exports.newOutlet = function(socketParam, onLoginCallback){
    ...
    //            }
                if(messageObj.meta.command == "start"){
                    ...
                    var swarming = util.newSwarmPhase(messageObj.meta.swarmingName,ctorName);
                    var initVars = thisAdapter.compiledSwarmingDescriptions[messageObj.meta.swarmingName].vars;
