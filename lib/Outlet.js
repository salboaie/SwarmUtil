...
exports.newOutlet = function(socketParam, onLoginCallback){
    ...
    //            }
                if(messageObj.command == "start"){
                    ...
                    if(thisAdapter.compiledSwarmingDescriptions[messageObj.swarmingName] == undefined){
                        logErr("Unknown swarm [" + messageObj.swarmingName + "]");
                        return;
                    }
    ...
    var channel = thisAdapter.coreId + outlet.sessionId;
