...
SwarmingPhase.prototype.broadcast = function (groupName,mess){
...
SwarmingPhase.prototype.honey = function(phase){
    if(this.meta.responseURI == undefined){
        this.swarm(phase,this.getSessionId())
    } else {
        var resp = this.meta.responseURI.split(":");
        startSwarm("WSResponse.js","response",this,resp[0],resp[1]);
    }
}
